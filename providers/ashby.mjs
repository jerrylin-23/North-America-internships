...
function resolveApiUrl(entry) {
  ...
  const subdomainMatch = url.match(/^https:\/\/([^.]+)\.ashbyhq\.com/);
  if (subdomainMatch && subdomainMatch[1] !== 'jobs') {
    return `https://api.ashbyhq.com/posting-api/job-board/${subdomainMatch[1]}?includeCompensation=true`;
  }
  return null;
}
